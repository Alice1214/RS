# -*- coding: utf-8 -*-
"""
* Content：使用DeepFM对movielens进行评分预测
* Author:  HuiHui
* Date:    2020-03-11
* Reference:
...
#movielens_sample数据集
# data = pd.read_csv("/Users/wangdonghui/Desktop/ZGZ/RS/AI-Training-Course/RS07/deepfm/movielens_sample.txt")
# sparse_features = ["movie_id", "user_id", "gender", "age", "occupation", "zip"]
# target = ['rating']

#movielens完整数据集
ratings = pd.read_csv("/Users/wangdonghui/Desktop/ZGZ/RS/AI-Training-Course/RS07/deepfm/movielens/ratings.csv")
movies = pd.read_csv("/Users/wangdonghui/Desktop/ZGZ/RS/AI-Training-Course/RS07/deepfm/movielens/movies.csv")
